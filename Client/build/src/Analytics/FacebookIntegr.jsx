...
const FacebookIntegr = () =>{
  ...
  return(
    <div className="flex min-h-screen " style={{display:"flex",width:"100%",background: "linear-gradient(45deg, #1877f2, #3b5998, #8b9dc3)",height:"100vh"}}>
      ...
      <div className="ml-64 flex-1 p-10 p-4"style={{width:"70%",marginLeft:"100px",marginTop:"100px"}}>
        <div className="max-w-5xl mx-auto  rounded-xl shadow-md p-10" style={{boxShadow:"0 0 10px black",borderRadius:"10px",padding:"50px"}} >
          <h1 className="text-3xl font-bold mb-4 text-gray-800">
            Connect your Facebook Page and extract all the analytics
          </h1>
          <p className="text-gray-600 text-lg mb-6">
            Extract the analytics related to your Page and improve your strategy based on the data.
          </p>

          <button onClick={loginWithFacebook} className="p-4  mb-4  text-white font-medium px-6 py-3 rounded-md flex items-center gap-2 transition duration-200" style={{background:"transparent",border:"none", paddingLeft:"3px"}}>
            <FaRss className="text-lg" />
           <span style={{padding:"10px",boxShadow:"0 0 10px black",borderRadius:"10px",background:"blue",marginLeft:"3px"}}>Connect Your Facebook</span>
          </button>
